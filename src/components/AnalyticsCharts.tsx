  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Статистика по районам</h3>
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={districtData}>
            ...
            <YAxis />
            <Tooltip />
            <Bar dataKey="negative" stackId="a" fill="#EF4444" name="Негативные" />
            <Bar dataKey="neutral" stackId="a" fill="#6B7280" name="Нейтральные" />
            <Bar dataKey="positive" stackId="a" fill="#10B981" name="Позитивные" />
          </BarChart>
        </ResponsiveContainer>
      </div>
